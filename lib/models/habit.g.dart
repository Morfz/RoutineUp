...
extension HabitQueryFilter on QueryBuilder<Habit, Habit, QFilterCondition> {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> scheduledDaysElementEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> scheduledDaysElementBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> scheduledDaysLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'scheduledDays',
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> scheduledDaysIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'scheduledDays',
        0,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> scheduledDaysIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'scheduledDays',
        0,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> scheduledDaysLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> scheduledDaysLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension HabitQueryWhereDistinct on QueryBuilder<Habit, Habit, QDistinct> {
  ...
  QueryBuilder<Habit, Habit, QDistinct> distinctByScheduledDays() {
    return QueryBuilder.apply(this, (query) {
...
extension HabitQueryProperty on QueryBuilder<Habit, Habit, QQueryProperty> {
  ...
  QueryBuilder<Habit, List<int>, QQueryOperations> scheduledDaysProperty() {
    return QueryBuilder.apply(this, (query) {
